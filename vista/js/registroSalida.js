...
async function cargarDatos() {
    try {
        const response = await fetch('https://almacen-syatec-a08f.onrender.com/extraer/visualizar');
...
document.addEventListener("DOMContentLoaded", async function () {
    ...
    if (form) {
        form.addEventListener("submit", async function (event) {
            ...
            try {
                const response = await fetch("https://almacen-syatec-a08f.onrender.com/extraer/agregar", {
                    method: "POST",
...
document.addEventListener("DOMContentLoaded", async function () {
    ...
    document.getElementById('formEditarSalida').addEventListener('submit', async function (event) {
        ...
        try {
            const response = await fetch(`https://almacen-syatec-a08f.onrender.com/extraer/actualizar/${editarData.id}`, {
                method: 'PUT',
                headers: {
...
async function eliminar(id) {
    ...
    try {
        const response = await fetch(`https://almacen-syatec-a08f.onrender.com/extraer/eliminar/${id}`, {
            method: 'DELETE'
        });
        if (response.ok) {
